...
public static void main(String[] args){
    ...
    {
    case "parayükleme":
    	System.out.println("Para yüklenicek hesabýn numarasýný giriniz:");
    	hesapnumara = scan.nextLine();
    	System.out.println("Yüklencek tutarý giriniz");
    	py = scan.nextInt();
    	{
    	System.out.println(hesapnumara  +" " + " Adlý Hesabýnýza" + " " + py + " TL yüklenecektir Onaylamak için 1'i, iptal etmek için 2yi tuþlayýn");
    	py2 = scan.nextInt();
    	if(py2 == 1)
    	{
